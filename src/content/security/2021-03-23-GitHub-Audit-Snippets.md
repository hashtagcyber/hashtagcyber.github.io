...
description: "A collection of scripts for auditing github"
pubDate: 2021-03-23T00:00:00.000Z
slug: "2021-03-23-GitHub-Audit-Snippets"
tags:
  - security
  - engineering
  - automation
...
_**They really should put the warnings before the spells**_
...
I like to store things like this in my keychain and load them as environs via .bash\_profile. Here’s a neat [gist](https://gist.github.com/bmhatfield/f613c10e360b4f27033761bbee4404fd) by [Bryan Hatfield](https://twitter.com/brianhatfield) to make it easy.
...
Github uses the `Link` header to track pages… here’s a function that pulls out the next\_url
...
I’m returning the cursor as well as the log\_data. Persisting the cursor would allow you to pickup where you left off on subsequent queries and _**REDUCES**_ (but does not eliminate) duplicates.
...
I don’t want to email [hashtagcyber@gmail.com](mailto:hashtagcyber@gmail.com) when a bug gets found; I want to cut a ticket for [hashtagcyber@dayjob.com](mailto:hashtagcyber@dayjob.com). To do this, I need a valid mapping of github users <> corporate email. If the organization uses SAML, I can use the GraphQL endpoint to retreive this mapping.
